...
static void
writeByte(uint8_t spiPort, uint8_t devId, uint8_t reg, uint8_t data)
{
    uint8_t spiData[4];
...
static uint8_t
readByte(uint8_t spiPort, uint8_t devId, uint8_t reg)
{
    uint8_t spiData[4];
...
int
mcp23s08Setup(const int pinBase, const int spiPort, const int devId)
{
