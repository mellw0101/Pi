...
void
piGlow1(const int leg, const int ring, const int intensity)
{
    int *legLeds;
...
void
piGlowLeg(const int leg, const int intensity)
{
    int  i;
    int *legLeds;
...
void
piGlowRing(const int ring, const int intensity)
{
    if ((ring < 0) || (ring > 5))
    {
        return;
