...
void
waitForConversion(int fd, unsigned char *buffer, int n)
{
    for (;;)
    {
...
int
myAnalogRead(struct wiringPiNodeStruct *node, int chan)
{
...
int
mcp3422Setup(int pinBase, int i2cAddress, int sampleRate, int gain)
{
    int                        fd;
