...
#include "../include/scrollPhat.h"
#include "../include/scrollPhatFont.h"
...
void
scrollPhatPoint(int x, int y, int colour)
{
    lastX = x;
    lastY = y;
...
void
scrollPhatLine(int x0, int y0, int x1, int y1, int colour)
{
    int dx, dy;
    int sx, sy;
    int err, e2;
...
void
scrollPhatLineTo(int x, int y, int colour)
{
...
void
scrollPhatRectangle(int x1, int y1, int x2, int y2, int colour, int filled)
{
    /* register  */ int x;
...
void
scrollPhatPrintf(const char *message, ...)
{
    va_list argp;
    char    buffer[1024];
...
void
scrollPhatPrintSpeed(const int pps)
{
    if (pps < 0)
    {
        printDelayFactor = 0;
...
void
scrollPhatIntensity(const int percent)
{
