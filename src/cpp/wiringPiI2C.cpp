...
int
wiringPiI2CReadBlockData(int fd, int reg, uint8_t *values, uint8_t size)
{
    union i2c_smbus_data data;
...
int
wiringPiI2CRawRead(int fd, uint8_t *values, uint8_t size)
{
...
int
wiringPiI2CWriteReg8(int fd, int reg, int value)
{
    union i2c_smbus_data data;
...
int
wiringPiI2CWriteReg16(int fd, int reg, int value)
{
    union i2c_smbus_data data;
...
int
wiringPiI2CWriteBlockData(int fd, int reg, const uint8_t *values, uint8_t size)
{
    union i2c_smbus_data data;
...
int
wiringPiI2CRawWrite(int fd, const uint8_t *values, uint8_t size)
{
