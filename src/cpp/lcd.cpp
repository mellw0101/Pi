...
static void
strobe(const struct lcdDataStruct *lcd)
{
...
static void
putCommand(const struct lcdDataStruct *lcd, unsigned char command)
{
...
static void
put4Command(const struct lcdDataStruct *lcd, unsigned char command)
{
...
int
lcdInit(const int rows, const int cols, const int bits, const int rs, const int strb, const int d0, const int d1,
        const int d2, const int d3, const int d4, const int d5, const int d6, const int d7)
{
