...
static int
maxDetectLowHighWait(const int pin)
{
...
static unsigned int
maxDetectClockByte(const int pin)
{
    unsigned int byte = 0;
    int          bit;
...
static int
maxDetectRead(const int pin, unsigned char buffer[4])
{
    int            i;
...
static int
myReadRHT03(const int pin, int *temp, int *rh)
{
    int           result;
...
int
rht03Setup(const int pinBase, const int piPin)
{
